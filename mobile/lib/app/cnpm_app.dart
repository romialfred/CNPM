...
class _CnpmAppState extends State<CnpmApp> {
  ...
  void initState() {
    ...
    _router = buildAppRouter(
      ...
      offlineStatusController: _composition.offlineStatusController,
      paymentController: _composition.paymentController,
      profileController: _composition.profileController,
      ...
      securityController: _composition.securityController,
      pendingSyncController: _composition.pendingSyncController,
