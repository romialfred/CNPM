...
7. `docs/00-governance/reprise-baseline-2026-07-18.md` — baseline et gates de la reprise premium.
8. `docs/00-governance/root-markdown-placement.md` — emplacement exact des fichiers Markdown.
