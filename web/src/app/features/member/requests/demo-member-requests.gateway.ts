...
const INITIAL_REQUESTS: readonly MemberRequestDetail[] = [
  fixture(1, {
    ...
    description:
      'Cette demande fictive sert à illustrer un échange autour d’une pièce de démonstration.',
    ...
    conversation: [
      message(
        ...
        'MEMBER',
        'Membre fictif',
        'Bonjour, quelle pièce fictive dois-je ajouter à ce scénario ?',
      ...
      message(
        ...
        'CNPM',
        'Équipe CNPM fictive',
        'Merci. Pour poursuivre la démonstration, une pièce justificative fictive est demandée.',
    ...
    requestedDocuments: [
      {
        ...
        label: 'Justificatif fictif au format PDF',
        state: 'REQUESTED',
      },
    ],
  }),
  fixture(2, {
    reference: 'DEMO-REQ-MEMBRE-2026-0005',
    kind: 'REQUEST',
    category: 'DEMO_PORTAL',
    subject: 'Question sur le portail de démonstration',
    description: 'Question fictive concernant un accès de démonstration, sans compte réel.',
    status: 'IN_PROGRESS',
  ...
  fixture(3, {
    reference: 'DEMO-REC-MEMBRE-2026-0004',
    kind: 'CLAIM',
    category: 'DEMO_CLAIM',
    subject: 'Signaler un délai dans un parcours fictif',
    description: 'Réclamation fictive destinée à tester un état de délai dépassé.',
    status: 'IN_PROGRESS',
  ...
  fixture(4, {
    reference: 'DEMO-REQ-MEMBRE-2026-0003',
    kind: 'REQUEST',
    category: 'DEMO_INFORMATION',
    subject: 'Demander une information fictive',
    description: 'Demande d’information purement illustrative.',
    status: 'RESOLVED',
    ...
    conversation: [
      message(
        ...
        'MEMBER',
        'Membre fictif',
        'Pouvez-vous préciser le fonctionnement de ce scénario fictif ?',
      ...
      message(
        ...
        'CNPM',
        'Équipe CNPM fictive',
        'Une réponse de démonstration a été apportée. Elle ne constitue pas une réponse institutionnelle.',
        '2026-07-15T13:00:00Z',
      ),
    ],
  }),
  fixture(5, {
    reference: 'DEMO-REQ-MEMBRE-2026-0002',
    kind: 'REQUEST',
    category: 'DEMO_DOCUMENT',
    subject: 'Suivre un document simulé',
    description: 'Scénario de pièce fournie sous forme de métadonnée uniquement.',
    status: 'CLOSED',
    ...
    requestedDocuments: [
      {
        ...
        label: 'Pièce fictive déclarée comme fournie',
        state: 'PROVIDED',
      },
    ],
  }),
  fixture(6, {
    reference: 'DEMO-REC-MEMBRE-2026-0001',
    kind: 'CLAIM',
    category: 'DEMO_CLAIM',
    subject: 'Retour sur une expérience simulée',
    description: 'Ancienne réclamation fictive clôturée dans la fixture.',
    status: 'CLOSED',
...
export class DemoMemberRequestsGateway implements MemberRequestsGateway {
  ...
  create(input: CreateMemberRequestInput): Observable<MemberRequestDetail> {
    ...
    const detail: MemberRequestDetail = {
      ...
      reference: `DEMO-${input.kind === 'CLAIM' ? 'REC' : 'REQ'}-MEMBRE-2026-${suffix}`,
      kind: input.kind,
