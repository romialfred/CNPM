...
/**
 * Les valeurs financières et chaque solde proviennent de la source de consultation ;
 * cet adaptateur ne recalcule aucun montant.
 */
const DEMO_CONTRIBUTIONS: readonly MemberContributionDetail[] = [
    ...
    adjustments: [
      {
        ...
        amount: 15000,
        currency: 'XOF',
        reason: 'Ajustement fourni par la source de consultation',
  ...
  },
  {
    ...
    status: 'A_ECHOIR',
    amountOriginNote:
      'Aucun calcul réglementaire n’est effectué tant que la décision DEC-008 reste ouverte.',
    adjustments: [],
    schedule: [
      {
  ...
  },
  {
    ...
    status: 'EN_RETARD',
    amountOriginNote:
      'Le retard est un état fourni par la source de consultation, non déduit par l’interface.',
    adjustments: [],
    schedule: [
      {
        id: 'demo-installment-2025-01-a',
        label: 'Échéance 1 sur 2',
        dueDate: '2025-03-31',
  ...
  },
  {
    ...
    status: 'REGLEE',
    amountOriginNote:
      'Aucun barème institutionnel n’est représenté tant que la décision DEC-008 reste ouverte.',
    adjustments: [],
    schedule: [
      {
  ...
  },
  {
    ...
    status: 'PARTIELLE',
    amountOriginNote:
      'Aucun barème institutionnel n’est appliqué tant que la décision DEC-008 reste ouverte.',
    adjustments: [],
    schedule: [
      {
