...
export class DemoBankStatementImportGateway implements BankStatementImportGateway {
  ...
  inspectLocalDemo(file: BankStatementLocalFile): Observable<BankStatementInspection> {
    if (!file.fileName.toLowerCase().endsWith('.csv')) {
      return throwError(() => new Error('Seul un fichier CSV est accepté.'));
    }
      ...
      lines: [
        {
          ...
          reference: 'VIR-2024-0628-1042',
          payer: 'Sahel Innovation SARL',
          amount: 12_500_000,
          status: 'VALID',
          explanation: 'Référence structurée reconnue dans le référentiel.',
        },
        {
          id: 'line-002',
          valueDate: '2024-06-28',
          reference: 'VIR-2024-0628-1043',
          payer: 'Kora Industrie SA',
          amount: 8_750_000,
          status: 'DUPLICATE',
          explanation: 'Référence déjà présente dans le lot précédent.',
        },
        {
          id: 'line-003',
          valueDate: '2024-06-29',
          reference: 'VIR-2024-0629-1048',
          payer: 'Atelier Horizon SARL',
          amount: 7_250_000,
          status: 'UNALLOCATED',
          explanation: 'Aucun appel ne correspond à la référence.',
        },
        {
          id: 'line-004',
          valueDate: '2024-06-29',
          reference: 'VIR-2024-0629-1051',
          payer: 'Nimba Services SAS',
          amount: 3_250_000,
          status: 'INVALID',
          explanation: 'Date de valeur absente dans le fichier source.',
        },
        {
          id: 'line-005',
          valueDate: '2024-06-30',
          reference: 'VIR-2024-0630-1055',
          payer: 'Djoliba Emballages SARL',
          amount: 5_400_000,
          status: 'VALID',
          explanation: 'Contrôles locaux satisfaits.',
        },
      ],
    }).pipe(delay(160));
  }
