...
const LOGS: readonly IntegrationLogEntry[] = [
  {
    ...
    outcome: 'SUCCESS',
    correlationLabel: 'COGEF-INT-0248',
    contractVersion: 'v1-2026',
  ...
  },
  {
    ...
    outcome: 'RETRYING',
    correlationLabel: 'COGEF-INT-0247',
    contractVersion: 'v2-2026',
  ...
  },
  {
    ...
    outcome: 'SUCCESS',
    correlationLabel: 'COGEF-INT-0246',
    contractVersion: 'v1-2026',
  ...
  },
  {
    ...
    outcome: 'BLOCKED',
    correlationLabel: 'COGEF-INT-0245',
    contractVersion: 'v1-2026',
  ...
  },
  {
    ...
    exchangeLabel: 'Dépôt',
    outcome: 'REJECTED',
    correlationLabel: 'COGEF-INT-0244',
    contractVersion: 'v1-2026',
