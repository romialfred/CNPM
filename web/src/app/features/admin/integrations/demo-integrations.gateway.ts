...
const PARTNERS: readonly IntegrationPartner[] = [
  {
    ...
    name: 'Registre Démo Alpha',
    purpose: 'Synchronisation fictive de fiches d’entreprise',
    channelLabel: 'API simulée · lecture seule',
    ...
    successRate24h: 99.4,
    events24h: 186,
    statusDetail: 'Échanges fictifs reçus et provenance disponible.',
  },
  {
    id: 'demo-integration-002',
    name: 'Paiement Sandbox Bêta',
    purpose: 'Accusés de paiement strictement fictifs',
    channelLabel: 'Callback simulé · aucune transaction',
    environmentLabel: 'Bac à sable fictif',
    health: 'DEGRADED',
    contractVersion: 'v2-demo',
    authorization: 'DOCUMENTED',
    authorizationLabel: 'Autorisation documentée',
    externalMappings: 8,
    ...
    successRate24h: 94.7,
    events24h: 74,
    statusDetail: 'Deux réponses fictives sont en reprise automatique.',
  },
  {
    id: 'demo-integration-003',
    name: 'Messagerie Démo Gamma',
    purpose: 'Notifications de test sans destinataire réel',
    channelLabel: 'File locale simulée',
    environmentLabel: 'Simulation locale',
    health: 'PAUSED',
    contractVersion: 'v1-demo',
  ...
  },
  {
    ...
    name: 'Archivage Démo Delta',
    purpose: 'Dépôt fictif de preuves techniques non sensibles',
    channelLabel: 'Stockage simulé · métadonnées seules',
    environmentLabel: 'Bac à sable fictif',
    health: 'UNAVAILABLE',
    contractVersion: 'v1-demo',
    ...
    successRate24h: 0,
    events24h: 1,
    statusDetail: 'Aucun import : le contrat de démonstration reste incomplet.',
  },
];
...
const LOGS: readonly IntegrationLogEntry[] = [
  {
    ...
    partnerName: 'Registre Démo Alpha',
    direction: 'INBOUND',
    exchangeLabel: 'Import fictif contrôlé',
    outcome: 'SUCCESS',
    correlationLabel: 'DEMO-INT-0248',
    contractVersion: 'v1-demo',
  ...
  },
  {
    ...
    direction: 'INBOUND',
    exchangeLabel: 'Accusé fictif',
    outcome: 'RETRYING',
    correlationLabel: 'DEMO-INT-0247',
    contractVersion: 'v2-demo',
    provenanceLabel: 'Scénarios synthétiques Bêta',
    qualityLabel: 'Réponse incomplète',
    detail: 'Reprise automatique simulée ; rejeu manuel indisponible.',
  },
  {
    id: 'demo-log-003',
    ...
    partnerName: 'Registre Démo Alpha',
    direction: 'OUTBOUND',
    exchangeLabel: 'Confirmation fictive',
    outcome: 'SUCCESS',
    correlationLabel: 'DEMO-INT-0246',
    contractVersion: 'v1-demo',
    provenanceLabel: 'Journal local de démonstration',
    qualityLabel: 'Conforme au scénario',
    detail: 'Confirmation simulée sans donnée d’entreprise.',
  },
  {
    id: 'demo-log-004',
    ...
    partnerName: 'Messagerie Démo Gamma',
    direction: 'OUTBOUND',
    exchangeLabel: 'Notification fictive',
    outcome: 'BLOCKED',
    correlationLabel: 'DEMO-INT-0245',
    contractVersion: 'v1-demo',
  ...
  },
  {
    ...
    partnerName: 'Archivage Démo Delta',
    direction: 'OUTBOUND',
    exchangeLabel: 'Dépôt fictif',
    outcome: 'REJECTED',
    correlationLabel: 'DEMO-INT-0244',
    contractVersion: 'v1-demo',
    provenanceLabel: 'Lot synthétique Delta',
    qualityLabel: 'Bloquée avant import',
    detail: 'Rejet contrôlé : contrat de démonstration incomplet.',
  },
];
