 ...
 * qui est celui de Ouagadougou (Africa/Ouagadougou) : la fiche exige que le fuseau et la date
...
const DELIVERIES: readonly DeliveryRow[] = [
  ...
  },
  {
    ...
    organization: 'Nakambé Textile SARL',
  ...
  },
  {
    ...
    organization: 'Banfora Logistique SA',
  ...
  },
  {
    ...
    organization: 'Kaya Ciment SA',
    destination: 'relance@kaya-ciment.example',
    channel: 'EMAIL',
    status: 'OPENED',
  ...
  },
  {
    ...
    organization: 'Ouagadougou Digital SARL',
    destination: 'direction@ouaga-digital.example',
    channel: 'EMAIL',
    status: 'OPENED',
    sentAt: '2026-07-13T09:32:00+00:00',
    failureReason: null,
  ...
  },
  {
    ...
    organization: 'Fada N’Gourma Transit SARL',
  ...
  },
  {
    ...
    organization: 'Bobo-Dioulasso Coton SA',
  ...
  },
  {
    ...
    organization: 'Koudougou Industries SA',
    destination: 'tresorerie@koudougou-industries.example',
    channel: 'EMAIL',
    status: 'OPENED',
  ...
  },
  {
    ...
    organization: 'Ouahigouya Pêche SA',
    destination: 'contact@ouahigouya-peche.example',
    channel: 'EMAIL',
    status: 'DELIVERED',
    sentAt: '2026-06-02T09:01:00+00:00',
    failureReason: null,
  },
  {
    ...
    campaignReference: 'REL-2026-001',
    campaignLabel: 'Relance J+15 — cotisation 2026',
    memberCode: 'COGEF-2026-0113',
    organization: 'Dori Énergie SARL',
    destination: 'admin@dori-energie.example',
    channel: 'EMAIL',
    status: 'FAILED',
...
const PLEDGES: readonly PledgeRow[] = [
  ...
  {
    id: 'PLD-0016',
    memberCode: 'COGEF-2026-0121',
    organization: 'Manga Bois SARL',
...
const RECOVERY_ACTIONS: readonly RecoveryActionRow[] = [
  {
    ...
    reference: 'COGEF-ACT-2026-0001',
    memberCode: 'COGEF-MEMBRE-0001',
    organization: 'Organisation Alpha',
    agentLabel: 'Agent de recouvrement',
    kind: 'EMAIL',
    status: 'DUE_TODAY',
    scheduledAt: '2026-07-19T09:00:00+00:00',
    campaignReference: 'COGEF-CAMP-0001',
    campaignLabel: 'Campagne — échéances de juillet',
    segment: 'Segment A',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0002',
    memberCode: 'COGEF-MEMBRE-0002',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0003',
    memberCode: 'COGEF-MEMBRE-0003',
    organization: 'Organisation Gamma',
    agentLabel: 'Agent de recouvrement',
    kind: 'CALL',
    status: 'OVERDUE',
    scheduledAt: '2026-07-18T15:00:00+00:00',
    campaignReference: 'COGEF-CAMP-0002',
    campaignLabel: 'Campagne — suivi manuel',
    segment: 'Segment B',
    contactDisclosure: 'Contact masqué',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0004',
    memberCode: 'COGEF-MEMBRE-0004',
    organization: 'Organisation Delta',
    agentLabel: 'Agent de recouvrement',
    kind: 'VISIT',
    status: 'SUSPENDED',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0005',
    memberCode: 'COGEF-MEMBRE-0005',
    organization: 'Organisation Epsilon',
    agentLabel: 'Agent de recouvrement',
    kind: 'MEETING',
    status: 'SUSPENDED',
    scheduledAt: '2026-07-20T10:00:00+00:00',
    campaignReference: 'COGEF-CAMP-0003',
    campaignLabel: 'Campagne — engagements',
    segment: 'Segment C',
    contactDisclosure: 'Contact masqué',
    communicationAuthorization: 'NOT_APPLICABLE',
    suspension: {
      ...
      reasonLabel: 'Promesse active',
    },
    promise: {
      amount: 750_000,
      dueDate: '2026-07-25',
      comment: 'Engagement consigné au dossier.',
      status: 'PENDING',
    },
    executionAvailable: false,
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0006',
    memberCode: 'COGEF-MEMBRE-0006',
    organization: 'Organisation Zêta',
    agentLabel: 'Agent de recouvrement',
    kind: 'EMAIL',
    status: 'PLANNED',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0007',
    memberCode: 'COGEF-MEMBRE-0007',
    organization: 'Organisation Êta',
    agentLabel: 'Agent de recouvrement',
    kind: 'CALL',
    status: 'DUE_TODAY',
  ...
  },
  {
    ...
    reference: 'COGEF-ACT-2026-0008',
    memberCode: 'COGEF-MEMBRE-0008',
    organization: 'Organisation Thêta',
    agentLabel: 'Agent de recouvrement',
    kind: 'SMS',
    status: 'SUSPENDED',
    ...
    promise: {
      amount: 320_000,
      dueDate: '2026-07-22',
      comment: 'Promesse à suivre sans relance automatique.',
      status: 'PENDING',
    },
    executionAvailable: false,
  },
...
const RECOVERY_PORTFOLIO: readonly RecoveryPortfolioCase[] = RECOVERY_ACTIONS.map((action) => {
  ...
  if (!financial) throw new Error(`Montant manquant pour ${action.id}`);
  return {
