...
const ROWS: readonly DocumentRegistryRow[] = [
  row(
    12,
    'Attestation d’adhésion — démonstration',
    'MEMBERSHIP',
    'Membre DEMO-0012',
    'CONFIDENTIAL',
    'CURRENT',
  ...
  row(
    10,
    'Justificatif de paiement fictif',
    'PAYMENT_SUPPORT',
    'Paiement DEMO-0010',
    'CONFIDENTIAL',
    'CURRENT',
  ...
  row(
    7,
    'RCCM fictif sans format normatif',
    'ORGANIZATION',
    'Entreprise DEMO-0007',
    'CONFIDENTIAL',
    'CURRENT',
  ...
  row(
    5,
    'Mandat interne fictif',
    'GOVERNANCE',
    'Commission DEMO-0005',
    'INTERNAL',
    'EXPIRING',
  ...
  row(
    3,
    'Statuts entreprise — simulation',
    'ORGANIZATION',
    'Entreprise DEMO-0003',
    'RESTRICTED',
    'CURRENT',
...
function row(
  ...
  return {
    ...
    demonstrationReference: `DEMO-DOC-2026-${String(index).padStart(4, '0')}`,
    title,
    kind,
    businessObjectLabel,
    classification,
    ...
    authorLabel: `Agent fictif ${String(index).padStart(2, '0')}`,
    updatedAt,
    expiresAt,
